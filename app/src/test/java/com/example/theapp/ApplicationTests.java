...
import com.example.theapp.data.CustomerProfileEntity;
import com.example.theapp.data.CustomerProfileRepository;
...
class ApplicationTests {
    ...
    void shouldReturnCustomerProfileOnGetRequest() {
        ...
        assertThat(responseEntity.hasBody()).isTrue();
        assertThat(responseEntity.getBody()).contains(entity.getId());
    }
}
